  ...
  <div class="card-body">
    ...
    <form method="post" action="{{ route('products.update', $product->id) }}" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="Comp_name" value="{{ $product->Company_name }}"/>
        </div>
          <div class="form-group">
          ...
          <select id="form-select"class="form-select" name="catagory" value="{{ $product->catagory }}">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="price" value="{{ $product->price }}" step="any"/>
        </div>
        <div class="form-group">
